...
char startcommand = 0x45 ; // ASCII – E, dec: 69,
...
{ 
  ...
  Serial.print("X = "); 
  Serial.print(smoothBMAx);Serial.print(",");
  Serial.print("Y = "); 
  Serial.print(smoothBMAy);Serial.print(",");
  Serial.print("Z = "); 
  Serial.print(smoothBMAz);Serial.print(",");
...
byte i2c_writeReg(int dev_i2c_address, byte reg_address, byte data)  // used in the i2c_writeOptionallyTo function
{
  ...
  delay(10);  //the BMA180 often needs some settling time after register writing
